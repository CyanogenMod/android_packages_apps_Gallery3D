...
public class OneTimeInitializer extends BroadcastReceiver {
    ...
    private void prepareTable(Context context) {
        ...
        ComponentName oldGallery = new ComponentName(
                oldPkg, "com.android.camera.GalleryPicker");
        ComponentName oldGalleryShort = new ComponentName(
                oldPkg, ".GalleryPicker");

        // The new names.
        ComponentName newGallery = new ComponentName(
                newPkg, "com.cooliris.media.Gallery");

        mMappingTable.add(new Entry(oldGallery, newGallery));
        mMappingTable.add(new Entry(oldGalleryShort, newGallery));
    }
